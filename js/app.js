...
//================================================================================
let myOurSpaces;
let mySliderAllSlides = document.querySelector('.slider-spaces__total');
let mySliderCurrentSlide = document.querySelector('.slider-spaces__current');
const mySlideCounter = document.querySelectorAll('.slider-spaces__slide').length;

myOurSpaces = new Swiper('.slider-spaces__wrapper', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	loop: true,
	navigation: {
		nextEl: '.slider-spaces__next',
		prevEl: '.slider-spaces__prev'
	},
	pagination: {
		el: '.slider-spaces__dotts',
		//Буллеты
		clickable: true,
	},
	...
	on: {
		...
		init: function (my) {
			mySliderAllSlides.innerHTML = setZeroFormat(mySlideCounter);
		},
		slideChange: function (my) {
			let currentSlide = ++my.realIndex;
			mySliderCurrentSlide.innerHTML = setZeroFormat(currentSlide);
		},
	}
});
//=========================================================================
...
mySliderAllSlides.innerHTML = myOurSpaces.slides.length;

myOurSpaces.on('slideChange', function () {
	let currentSlide = ++myOurSpaces.realIndex;
...
if (gallerySlider) {
	new Swiper(gallerySlider, {
		...
		lazy: true,
		navigation: {
			nextEl: '.gallery__next_left',
			prevEl: '.gallery__next_right'
		},
...
if (reviewsSlider) {
	new Swiper(reviewsSlider, {
		...
		// Dotts
		navigation: {
			nextEl: '.header-reviews__next_right',
			prevEl: '.header-reviews__next_left',
		},
		breakpoints: {
			// when window width is >= 320px
			320: {
...
if (isMobile.any()) {
	const sliderSpacesWrapper = document.querySelector('.slider-spaces__wrapper');
	if (sliderSpacesWrapper) {
		sliderSpacesWrapper.addEventListener("click", function (e) {
			let item = e.target;
			if (item.closest('.slider-spaces__slide')) {
				item.closest('.slider-spaces__slide').classList.toggle('_active');
			};
		});
	};
}
